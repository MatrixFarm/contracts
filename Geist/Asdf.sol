...
interface IMasterChef {
    function deposit(address poolToken, uint256 _amount) external;

    function withdraw(address poolToken, uint256 _amount) external;

    function claim(
        address _stakerAddress,
        address[] calldata _stakingTokenAddress
    ) external;

    function claimR(address staker, address token) external;
    ...
    function userInfo(address _stakingTokenAddress, address _stakerAddress)
        external
        view
        returns (uint256, uint256);

    function emergencyWithdraw(address _stakedToken) external;
}
...
contract StratManager is Ownable, Pausable {
    address public strategist =
        address(0xAA4273346D21A935BDf1302418D9531342D8142c);
    address public unirouter =
        address(0xF491e7B69E4244ad4002BC14e878a34207E38c29);
    address public vault;
    address public grimFeeRecipient =
        address(0x31EA27247F7FE065108a08F8EA9888234e909A6C);
...
contract StrategyMasterChefLP is StratManager {
    ...
    address assetManager = address(0x9FAD24f572045c7869117160A571B2e50b10d068);
    address geistPool = address(0x49c93a95dbcc9A6A4D8f77E59c038ce5020e82f8);
    ...
    constructor(address _want, address _output) public {
        ...
        poolToken = want;
        LP = [poolToken];
        // [0xd8321AA83Fb0a4ECd6348D4577431310A6E0814d,0x07E6332dD090D287d3489245038daF987955DCFB,0x25c130B2624CF12A4Ea30143eF50c5D68cEFA22f,0x39B3bd37208CBaDE74D0fcBDBb12D606295b430a,0x38aCa5484B8603373Acc6961Ecd57a6a594510A30x940F41F0ec9ba1A34CF001cc03347ac092F5F6B5,0xe578C856933D8e1082740bf7661e379Aa2A30b26]
        rewardTokens = [
    ...
    function deposit() public whenNotPaused {
        ...
        IMasterChef(masterchef).deposit(poolToken, wantBal);
    }
    ...
    function withdraw(uint256 _amount) external {
        ...
        IMasterChef(masterchef).withdraw(poolToken, _amount.sub(wantBal));
    ...
    function claimReward() external {
        require(msg.sender == strategist, "!auth");
        IMasterChef(masterchef).claim(address(this), LP);
    }

    // compounds earnings and charges performance fee
    function harvest() external whenNotPaused onlyWhitelisted {
        IMasterChef(masterchef).claim(address(this), LP);
        IGeistPool(geistPool).getReward();
        IGeistPool(geistPool).exit();
        chargeFees();
        addLiquidity();
        deposit();
    ...
    function chargeFees() internal {
        uint256 outputBal = IERC20(output)
    ...
    function retireStrat() external {
        ...
        IMasterChef(masterchef).emergencyWithdraw(poolToken);
