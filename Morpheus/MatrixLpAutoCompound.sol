...
contract MatrixLpAutoCompound is Ownable, Pausable {
    ...
    function chargeFees() internal {
        uint256 toWftm = IBEP20(output).balanceOf(address(this)).mul(totalFee).div(PERCENT_DIVISOR);
    ...
    function addLiquidity() internal {
        uint256 outputHalf = IBEP20(output).balanceOf(address(this)).div(2);
    ...
    function _giveAllowances() internal {
        ...
        IBEP20(output).approve(unirouter, uint256(-1));
    ...
    function _removeAllowances() internal {
        ...
        IBEP20(output).approve(unirouter, 0);
        IERC20(lpToken0).safeApprove(unirouter, 0);
        IERC20(lpToken1).safeApprove(unirouter, 0);
    }
